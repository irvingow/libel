...
Logger::Logger(Libel::Logger::PreDefineMacroHelper fileName,
               const char *functionName,
               int line,
               Libel::Logger::LogLevel level) :insideHelper_(fileName, functionName, line, level, 0) {}
...
void Logger::setOutput(Libel::Logger::OutputFunc outputFunc) {
    AOutput = outputFunc;
}

void Logger::setFlush(Libel::Logger::FlushFunc flushFunc) {
    AFlush = flushFunc;
}
...
Logger::InsideHelper::InsideHelper(
    Libel::Logger::PreDefineMacroHelper fileName,
    const char* functionName, int line,
    Libel::Logger::LogLevel level, int last_errno)
    : fileName_(fileName),
