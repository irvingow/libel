...
struct ThreadData {
  typedef Libel::Thread::ThreadFunc ThreadFunc;
  ThreadFunc func_;
  ...
  ThreadData(ThreadFunc func, void* user_data, std::string name,
  ...
  void runInThread() {
    *tid_ = CurrentThread::tid();
    tid_ = nullptr;
    Libel::CurrentThread::threadName =
...
Thread::Thread(Libel::Thread::ThreadFunc func, void* user_data,
               std::string name)
    : started_(false),
      joined_(false),
      pthreadID_(0),
